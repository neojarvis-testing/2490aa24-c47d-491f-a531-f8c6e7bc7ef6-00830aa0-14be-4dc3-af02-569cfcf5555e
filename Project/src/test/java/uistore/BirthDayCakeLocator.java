...
public class BirthDayCakeLocator {

        public static By nothanks = By.cssSelector("#wzrk-cancel");
        public static By location = By.cssSelector(
                        "span[class='flex items-center justify-start gap-4 text-12 font-500 xxl:text-14 text-red-500 ']");
        ...
        public static By pin_contains_Chennai = By.cssSelector(
                        "span[class='w-full max-w-[150px] overflow-hidden text-ellipsis whitespace-nowrap md:max-w-[200px]']");
